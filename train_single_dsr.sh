...
PYTHONUNBUFFERED=1 python -m verl.trainer.main_ppo \
    ...
    trainer.default_local_dir="/nas/home/jaymin/verl-checkpoints/outputs/grpo_$(date +%d-%m_%H%M)" \
    trainer.project_name=rlvr-drs-one-example \
    trainer.experiment_name=rlvr-drs-one-example \
